import type { HideSeekLevel, HideSeekState, VocabularyEntity } from '../../src/game/hide-seek/contracts';
import { createState, startReveal, finishReveal, submitAnswer, acknowledgeFeedback,
  setPaused, independentCorrectCount } from '../../src/game/hide-seek/rules';
