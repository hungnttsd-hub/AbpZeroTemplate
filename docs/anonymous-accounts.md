...
5. Production cần certificate RSA có private key: file PFX/PFX Base64 hoặc certificate store `CurrentUser/My`, `LocalMachine/My`. Render xem [hướng dẫn Secret Files](render-data-protection.md). App từ chối bật tạo anonymous production nếu thiếu certificate. Development có thể dùng Data Protection key ring hiện tại mà không có certificate.
