...
public static class AbpIoTemplateProjectEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE AbpIoTemplateProjectModuleExtensionConfigurator CLASS (in the Domain.Shared project)
