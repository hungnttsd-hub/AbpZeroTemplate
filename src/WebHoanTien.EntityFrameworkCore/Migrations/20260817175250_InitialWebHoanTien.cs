...
{
    /// <inheritdoc />
    public partial class InitialWebHoanTien : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RangeFrom = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    RangeTo = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InitialStartDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AffiliateUrl = table.Column<string>(type: "character varying(2048)", maxLength: 2048, nullable: true),
                    ProductId = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                    ShopId = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                    ProductName = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    ImageUrl = table.Column<string>(type: "character varying(2048)", maxLength: 2048, nullable: true),
                    EstimatedCommission = table.Column<decimal>(type: "numeric(20,4)", precision: 20, scale: 4, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tracking_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserLegalConsent", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserLegalConsent_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Click_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Click_Tracking_TrackingId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Platform = table.Column<int>(type: "integer", nullable: false),
                    ExternalConversionId = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                    TrackingId = table.Column<Guid>(type: "uuid", nullable: true),
                    UserId = table.Column<Guid>(type: "uuid", nullable: true),
                    AttributionValue = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                    PurchaseTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ClickTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    GrossCommission = table.Column<decimal>(type: "numeric(20,4)", precision: 20, scale: 4, nullable: false),
                    NetCommission = table.Column<decimal>(type: "numeric(20,4)", precision: 20, scale: 4, nullable: false),
                    CommissionSource = table.Column<int>(type: "integer", nullable: false),
                    UserShareRate = table.Column<decimal>(type: "numeric(7,4)", precision: 7, scale: 4, nullable: false),
                    UserCommissionSnapshot = table.Column<decimal>(type: "numeric(20,4)", precision: 20, scale: 4, nullable: false),
                    PlatformRevenueSnapshot = table.Column<decimal>(type: "numeric(20,4)", precision: 20, scale: 4, nullable: false),
                    PayableUserCommission = table.Column<decimal>(type: "numeric(20,4)", precision: 20, scale: 4, nullable: false),
                    LastProviderUpdateAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ExtraProperties = table.Column<string>(type: "text", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Conversion_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Conversion_Tracking_TrackingId",
                        column: x => x.TrackingId,
                        principalSchema: "affiliate",
                        principalTable: "Tracking",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "integer", nullable: false),
                    ShopType = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Order_Conversion_ConversionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConversionId = table.Column<Guid>(type: "uuid", nullable: true),
                    PayloadType = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    SanitizedJson = table.Column<string>(type: "jsonb", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RawPayload", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RawPayload_Conversion_ConversionId",
                        column: x => x.ConversionId,
                        principalSchema: "affiliate",
                        principalTable: "Conversion",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_RawPayload_SyncRun_SyncRunId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Click_TrackingId_ClickedAt",
                schema: "affiliate",
                table: "Click",
                columns: new[] { "TrackingId", "ClickedAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommissionRule_Platform_EffectiveFrom",
                schema: "affiliate",
                table: "CommissionRule",
                columns: new[] { "Platform", "EffectiveFrom" });

            migrationBuilder.CreateIndex(
                name: "IX_Conversion_Platform_ExternalConversionId",
                schema: "affiliate",
                table: "Conversion",
                columns: new[] { "Platform", "ExternalConversionId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Conversion_TrackingId",
                schema: "affiliate",
                table: "Conversion",
                column: "TrackingId");

            migrationBuilder.CreateIndex(
                name: "IX_Conversion_UserId_PurchaseTime",
                schema: "affiliate",
                table: "Conversion",
                columns: new[] { "UserId", "PurchaseTime" });
            ...
            migrationBuilder.CreateIndex(
                ...
                schema: "affiliate",
                table: "Order",
                columns: new[] { "ConversionId", "ExternalOrderId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RawPayload_ConversionId",
                schema: "affiliate",
                table: "RawPayload",
                column: "ConversionId");

            migrationBuilder.CreateIndex(
                name: "IX_RawPayload_ExpiresAt",
                schema: "affiliate",
                table: "RawPayload",
                column: "ExpiresAt");

            migrationBuilder.CreateIndex(
                name: "IX_RawPayload_SyncRunId",
                schema: "affiliate",
                table: "RawPayload",
                column: "SyncRunId");

            migrationBuilder.CreateIndex(
                name: "IX_SyncRun_Platform_SyncKind_StartedAt",
                schema: "affiliate",
                table: "SyncRun",
                columns: new[] { "Platform", "SyncKind", "StartedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_SyncState_Platform_SyncKind",
                schema: "affiliate",
                table: "SyncState",
                columns: new[] { "Platform", "SyncKind" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Tracking_TrackingToken",
                schema: "affiliate",
                table: "Tracking",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tracking_UserId_Platform_NormalizedUrl",
                schema: "affiliate",
                table: "Tracking",
                columns: new[] { "UserId", "Platform", "NormalizedUrl" },
                unique: true,
                filter: "\"Status\" = 1 AND \"IsDeleted\" = FALSE");

            migrationBuilder.CreateIndex(
                name: "IX_UserLegalConsent_UserId_TermsVersion_PrivacyVersion",
                schema: "affiliate",
                table: "UserLegalConsent",
                columns: new[] { "UserId", "TermsVersion", "PrivacyVersion" },
                unique: true);
        }
